...
def faceDetection(test_img):             
    ...
    face_haar=cv2.CascadeClassifier(r'E:\Rajiv Gandhi Institute of Technology\Semester 6\ML Mini Project\Project\Face-Recognition\haarcascade_frontalface_alt.xml') #Give path to haar classifier as i have given
