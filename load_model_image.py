...
face_recognizer.read(r'E:\Rajiv Gandhi Institute of Technology\Semester 6\ML Mini Project\Project\Face-Recognition\trainingData.yml')  #Give path of where trainingData.yml is saved
